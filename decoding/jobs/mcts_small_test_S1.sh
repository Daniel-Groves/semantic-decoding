...
#SBATCH -n 4
#SBATCH --mem=32G
#SBATCH --job-name=mcts_small_S1
#SBATCH -o mcts_small_S1.o%j

echo "========================================================"
echo "MCTS DECODER — SMALL BEAM FULL STORY TEST"
echo "========================================================"
...
echo ""
echo "=== Running MCTS decoder (small: width=5, sims=20, depth=2) ==="
