...
#SBATCH -n 12
#SBATCH --mem=96G
#SBATCH --job-name=mcts_decode_S1
#SBATCH -o mcts_decode_S1.o%j

echo "========================================================"
echo "MCTS DECODER — S1 wheretheressmoke"
echo "========================================================"
...
cp ${RESULTS_DIR}/wheretheressmoke_mcts.npz ${RESULTS_DIR}/wheretheressmoke.npz

python3 -u evaluate_predictions.py \
    --subject S1 --experiment perceived_speech \
    --task wheretheressmoke

cp ${SCORES_DIR}/wheretheressmoke.npz ${SCORES_DIR}/wheretheressmoke_mcts.npz

echo ""
echo "========================================================"
echo "MCTS DECODE COMPLETE"
echo "========================================================"
